...
本项目的前端界面风格与部分功能设计参考了 [SmartStrm](https://github.com/Cp0204/SmartStrm)（作者 Cp0204），在此向原作者表示感谢。

需要说明的是：

- **没有对原项目进行任何逆向工程**，仅通过观察其公开界面学习 UI 风格与交互设计；
- 本项目的实现代码为独立编写（Go + 原生前端，无第三方框架依赖），未使用原项目的任何代码；
- 原项目功能丰富（支持多种网盘驱动、影视识别、302 代理等），部分高级功能需要付费许可；本项目定位为**轻量化替代**，只保留 STRM 生成核心功能，为不需要付费功能的用户提供一个开源、可自由部署的选择。

如果你觉得 SmartStrm 好用且需要其完整功能，请支持原作者（[SmartStrm 许可商店](https://licenserver.0x69.win/store/smartstrm)）。
